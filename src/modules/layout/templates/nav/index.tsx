    ...
    <div className="sticky top-0 inset-x-0 z-50 group">
      <div className="h-[45px] bg-[#2d2a6e] text-white text-[13px] flex justify-around items-center">
        <div className="hidden md:flex justify-between items-center">
          ...
          <a href="https://www.instagram.com/Mari-Cris" className="cursor-pointer" target="_blank">
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-[14px] w-[14px] mr-2" fill="white">
          ...
          <span className="text-[14px] md:text-[12px] text-white">
            ¡Síguenos!
          </span>
        </div>
      ...
      <header className="relative h-16 px-8 mx-auto duration-200 bg-white text-[#4D5574] border-b-[1px] border-[#e6eaf0]">
        <nav className="txt-xsmall-plus text-ui-fg-subtle flex items-center justify-between w-full h-full text-small-regular">
          ...
          <div className="flex items-center gap-x-6 h-full flex-1 basis-0 justify-end">
            <div className="hidden small:flex items-center gap-x-6 h-full">
              ...
              <Link className="text-[#4D5574] hover:underline" href="/account">
                Cuenta
              </Link>
            </div>
            <CartDropdown />
