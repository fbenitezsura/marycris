...
const ProductTabs = ({ product }: ProductTabsProps) => {
  ...
  const tabs = useMemo(() => {
    ...
    // Agregar la pestaña adicional si el título incluye 'huevos'
    if (product.title?.toLowerCase().includes('huevos') || product.title.toLowerCase().includes('huevo')) {
      baseTabs.push({
...
function useState(arg0: { label: string; component: JSX.Element }[]): [any, any] {
