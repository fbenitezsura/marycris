      ...
      <div className="container mx-auto">
        <div className="grid-cols-12 flex justify-center">
          <div className="col-span-12 md:col-span-3">
            ...
            />
            <div className="col-span-12 md:col-span-3">
              <div className="rounded-[10px] mt-[10px]">
          ...
          <div className="col-span-12 md:col-span-9 grid grid-cols-12">
            <div className="col-span-12 mt-[56px] relative">
              <img className="ml-[15px] mr-[15px] rounded-[10px] max-w-[1110px]" width="100%" src="https://orfarm-next-js.vercel.app/assets/img/banner/shop-bg-1.jpg" />
