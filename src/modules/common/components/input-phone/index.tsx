        ...
        <div className="flex items-center">
          ...
          <div className="w-full relative">
            <input
              ...
              placeholder=""
              className={clsx(
                "pt-4 pb-1 block w-full h-11 relative px-4 mt-0 bg-ui-bg-field border rounded-md appearance-none focus:outline-none focus:ring-0 focus:shadow-borders-interactive-with-active border-ui-border-base hover:bg-ui-bg-field-hover",
                {
